...
void RoutingSession::BuildRoute2(Checkpoints const & checkpoints,ReadyCallback const & readyCallback,
                                 NeedMoreMapsCallback const & needMoreMapsCallback,
                                 RemoveRouteCallback const & removeRouteCallback)
{
    ...
    m_router->ClearState();
    m_router->CalculateRoute(checkpoints, direction, false,
                             DoReadyCallback(*this, readyCallback), needMoreMapsCallback,
                             removeRouteCallback, m_progressCallback, routing::RouterDelegate::kNoTimeout);
}
