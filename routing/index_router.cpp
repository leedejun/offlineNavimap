...
void IndexRouter::SetAvoidPolygon(std::vector<Polygon> const & polygons) { m_polygons = polygons; }
                                             ...
                                             RouterDelegate const & delegate, Route & route)
{
  ...
  try
  {
    ...
    VehicleModelFactoryInterface const & vehicleModelFactory = *m_vehicleModelFactory;
