...
//                    {CarDirection::ExitHighwayToRight, "ExitHighwayToRight"}}};
    g_turnNames = {{{CarDirection::None, "无"},
                    {CarDirection::GoStraight, "直行"},
                    {CarDirection::TurnRight, "右转弯"},
                    {CarDirection::TurnSharpRight, "右后方转弯"},
                    {CarDirection::TurnSlightRight, "右前方转弯"},
                    {CarDirection::TurnLeft, "左转弯"},
                    {CarDirection::TurnSharpLeft, "左后方转弯"},
                    {CarDirection::TurnSlightLeft, "左前方转弯"},
                    {CarDirection::UTurnLeft, "左掉头"},
                    {CarDirection::UTurnRight, "右掉头"},
                    {CarDirection::EnterRoundAbout, "进入环岛"},
                    {CarDirection::LeaveRoundAbout, "离开环岛"},
                    {CarDirection::StayOnRoundAbout, "继续在环岛上前行"},
                    {CarDirection::StartAtEndOfStreet, "在路的尽头开始"},
                    {CarDirection::ReachedYourDestination, "到达目的地"},
                    {CarDirection::ExitHighwayToLeft, "左边离开高速"},
                    {CarDirection::ExitHighwayToRight, "右边离开高速"}}};
