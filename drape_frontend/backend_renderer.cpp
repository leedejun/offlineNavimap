...
//      }
        ...
        case Message::Type::DrapeApiAddPolygons:
        {
          ref_ptr<DrapeApiAddPolygonsMessage> msg = message;
          CHECK(m_context != nullptr, ());
          std::vector<drape_ptr<DrapeApiRenderProperty>> properties;
          m_drapeApiBuilder->BuildPolygons(m_context, msg->GetPolygons(), m_texMng, properties);
          m_commutator->PostMessage(ThreadsCommutator::RenderThread,
                                    make_unique_dp<DrapeApiFlushMessage>(std::move(properties)),
                                    MessagePriority::Normal);
          break;
        ...
        case Message::Type::DrapeApiAddCustomMarks:
        {
          ref_ptr<DrapeApiAddCustomMarksMessage> msg = message;
          CHECK(m_context != nullptr, ());
          std::vector<drape_ptr<DrapeApiRenderProperty>> properties;
          m_drapeApiBuilder->BuildCustomMarks(m_context, msg->GetCustomMarks(), m_texMng, properties);
          m_commutator->PostMessage(ThreadsCommutator::RenderThread,
                                    make_unique_dp<DrapeApiFlushMessage>(std::move(properties)),
                                    MessagePriority::Normal);
          break;
