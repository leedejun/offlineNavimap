...
//    {
//      auto const baseClass = env->FindClass("com/ftmap/maps/search/HotelsFilter");
//      m_type = env->GetFieldID(baseClass, "mType", "I");
//    }
//
//    {
//      auto const andClass = env->FindClass("com/ftmap/maps/search/HotelsFilter$And");
//      m_andLhs = env->GetFieldID(andClass, "mLhs", "Lcom/ftmap/maps/search/HotelsFilter;");
//      m_andRhs = env->GetFieldID(andClass, "mRhs", "Lcom/ftmap/maps/search/HotelsFilter;");
//    }
//
//    {
//      auto const orClass = env->FindClass("com/ftmap/maps/search/HotelsFilter$Or");
//      m_orLhs = env->GetFieldID(orClass, "mLhs", "Lcom/ftmap/maps/search/HotelsFilter;");
//      m_orRhs = env->GetFieldID(orClass, "mRhs", "Lcom/ftmap/maps/search/HotelsFilter;");
//    }

//    {
//      auto const opClass = env->FindClass("com/ftmap/maps/search/HotelsFilter$Op");
//      m_field = env->GetFieldID(opClass, "mField", "I");
//      m_op = env->GetFieldID(opClass, "mOp", "I");
//    }

//    {
//      auto const oneOfClass = env->FindClass("com/ftmap/maps/search/HotelsFilter$OneOf");
//      auto const hotelTypeClass =
//          env->FindClass("com/ftmap/maps/search/HotelsFilter$HotelType");
//      m_oneOfType = env->GetFieldID(oneOfClass, "mType",
//                                    "Lcom/ftmap/maps/search/HotelsFilter$HotelType;");
//      m_oneOfTile =
//          env->GetFieldID(oneOfClass, "mTile", "Lcom/ftmap/maps/search/HotelsFilter$OneOf;");
//      m_hotelType = env->GetFieldID(hotelTypeClass, "mType", "I");
//    }

//    {
//      auto const ratingFilterClass =
//          env->FindClass("com/ftmap/maps/search/HotelsFilter$RatingFilter");
//      m_rating = env->GetFieldID(ratingFilterClass, "mValue", "F");
//    }
//
//    {
//      auto const priceRateFilterClass =
//          env->FindClass("com/ftmap/maps/search/HotelsFilter$PriceRateFilter");
...
//        jni::GetGlobalClassRef(env, "com/ftmap/maps/search/BookingFilterParams");
//    m_roomClass =
//        jni::GetGlobalClassRef(env, "com/ftmap/maps/search/BookingFilterParams$Room");
...
//                                "[Lcom/ftmap/maps/search/BookingFilterParams$Room;");
...
extern "C"
{
//com.ftmap.maps.search
JNIEXPORT void JNICALL
Java_com_ftmap_maps_search_SearchEngine_nativeInit(JNIEnv * env, jobject thiz)
{
  g_javaListener = env->NewGlobalRef(thiz);
  g_updateResultsId = jni::GetMethodID(env, g_javaListener, "onResultsUpdate",
                                       "([Lcom/ftmap/maps/search/SearchResult;JZ)V");
  g_endResultsId = jni::GetMethodID(env, g_javaListener, "onResultsEnd", "(J)V");
  g_resultClass = jni::GetGlobalClassRef(env, "com/ftmap/maps/search/SearchResult");
  g_resultConstructor = jni::GetConstructorID(
          env, g_resultClass,
          "(Ljava/lang/String;Lcom/ftmap/maps/search/SearchResult$Description;DD[IZZ"
          "Lcom/ftmap/maps/search/Popularity;)V");
  g_suggestConstructor = jni::GetConstructorID(env, g_resultClass, "(Ljava/lang/String;Ljava/lang/String;DD[I)V");
  g_descriptionClass = jni::GetGlobalClassRef(env, "com/ftmap/maps/search/SearchResult$Description");
  g_descriptionConstructor = jni::GetConstructorID(env, g_descriptionClass,
                                                   "(Lcom/ftmap/maps/data/FeatureId;"
                                                   "Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;"
                                                   "Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;"
                                                   "Ljava/lang/String;Ljava/lang/String;FIIZ)V");

  g_popularityClass = jni::GetGlobalClassRef(env, "com/ftmap/maps/search/Popularity");
  ...
  g_mapResultsMethod = jni::GetMethodID(env, g_javaListener, "onMapSearchResults",
                                        "([Lcom/ftmap/maps/search/NativeMapSearchListener$Result;JZ)V");
  g_mapResultClass = jni::GetGlobalClassRef(env, "com/ftmap/maps/search/NativeMapSearchListener$Result");
...
//                                                   "(I[Lcom/ftmap/maps/data/FeatureId;)V");

//    g_hotelsFilterBuilder.Init(env);
//    g_bookingBuilder.Init(env);
}

JNIEXPORT jboolean JNICALL Java_com_ftmap_maps_search_SearchEngine_nativeRunSearch(
...
JNIEXPORT void JNICALL Java_com_ftmap_maps_search_SearchEngine_nativeRunInteractiveSearch(
        JNIEnv * env, jclass clazz, jbyteArray bytes, jstring lang, jlong timestamp,
...
JNIEXPORT void JNICALL Java_com_ftmap_maps_search_SearchEngine_nativeRunSearchMaps(
        JNIEnv * env, jclass clazz, jbyteArray bytes, jstring lang, jlong timestamp)
{
...
//  JNIEXPORT jboolean JNICALL Java_com_ftmap_maps_search_SearchEngine_nativeRunSearchInBookmarks(
...
JNIEXPORT void JNICALL
Java_com_ftmap_maps_search_SearchEngine_nativeShowResult(JNIEnv * env, jclass clazz, jint index)
{
  g_framework->NativeFramework()->ShowSearchResult(g_results[index]);
}

JNIEXPORT void JNICALL
Java_com_ftmap_maps_search_SearchEngine_nativeCancelInteractiveSearch(JNIEnv * env, jclass clazz)
{
  g_framework->NativeFramework()->GetSearchAPI().CancelSearch(search::Mode::Viewport);
}

JNIEXPORT void JNICALL
Java_com_ftmap_maps_search_SearchEngine_nativeCancelEverywhereSearch(JNIEnv * env, jclass clazz)
{
  g_framework->NativeFramework()->GetSearchAPI().CancelSearch(search::Mode::Everywhere);
}

JNIEXPORT void JNICALL
Java_com_ftmap_maps_search_SearchEngine_nativeCancelAllSearches(JNIEnv * env, jclass clazz)
{
  g_framework->NativeFramework()->GetSearchAPI().CancelAllSearches();
}

JNIEXPORT jobjectArray JNICALL
Java_com_ftmap_maps_search_SearchEngine_nativeGetHotelTypes(JNIEnv * env, jclass clazz)
{
  using Type = ftypes::IsHotelChecker::Type;
  static jclass const hotelTypeClass =
          jni::GetGlobalClassRef(env, "com/ftmap/maps/search/HotelsFilter$HotelType");
