...
import com.ftmap.maps.settings.StoragePathManager;
...
public class StorageUtils
{
  ...
  public static String getApkPath(@NonNull Application application)
  {
    try
    {
      ...
      String apkPath = application.getPackageManager()
                        .getApplicationInfo(FTMap.INSTANCE.appId(), 0).sourceDir;
      return apkPath;
    }
  ...
  public static String getFilesPath(@NonNull Application application)
  {
    ...
    return Environment.getExternalStorageDirectory().getAbsolutePath() +
           String.format(Constants.STORAGE_PATH, FTMap.INSTANCE.appId(), Constants.FILES_DIR);
  }
  ...
  public static String getTempPath(@NonNull Application application)
  {
    ...
    return Environment.getExternalStorageDirectory().getAbsolutePath() +
           String.format(Constants.STORAGE_PATH, FTMap.INSTANCE.appId(), Constants.CACHE_DIR);
  }
  ...
  public static String getObbGooglePath()
  {
    ...
    return storagePath.concat(String.format(Constants.OBB_PATH, FTMap.INSTANCE.appId()));
  }
