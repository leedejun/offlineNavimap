...
public class LocationUtils
{
  ...
  {
    final ContentResolver resolver = FTMap.INSTANCE.getApp().getContentResolver();
    try
    {
  ...
  {
    LocationManager locMngr = (LocationManager) FTMap.INSTANCE.getApp().getSystemService(Context.LOCATION_SERVICE);
  ...
  {
    return checkProvidersAvailability(FTMap.INSTANCE.getApp());
  }
