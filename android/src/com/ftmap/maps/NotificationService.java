...
import com.ftmap.maps.LightFramework;
...
//import static com.ftmap.app.MapTestApplication.prefs;
...
/*  private boolean notifySmart()
  {
    if (MapTestApplication.backgroundTracker(getApplication()).isForeground())
      return false;
...
//    if (MapTestApplication.get().arePlatformAndCoreInitialized()
