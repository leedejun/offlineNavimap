...
public class StackedButtonsDialog extends AppCompatDialog implements View.OnClickListener
{
  ...
  @Nullable
  private final OnClickListener mPositiveListener;
  @Nullable
  private final String mNeutral;
  @Nullable
  private final OnClickListener mNeutralListener;
  @Nullable
  private final String mNegative;
  @Nullable
  private final OnClickListener mNegativeListener;
  ...
  public static final class Builder
  {
    ...
    @NonNull
    public Builder setCancelListener(@Nullable OnCancelListener listener)
    {
