...
//  private final int mPriceRate;
  ...
  public MapObject(@NonNull FeatureId featureId, @MapObjectType int mapObjectType, String title,
                   ...
                   boolean canBeReviewed, @Nullable Object ratings,
                   @Nullable HotelsFilter.HotelType hotelType,  int priceRate,
                   ...
                   @Nullable String[] rawTypes)
  {
    ...
    public MapObject(@NonNull FeatureId featureId, @MapObjectType int mapObjectType,
                   ...
                   @Nullable Object ratings, @Nullable HotelsFilter.HotelType hotelType,
                    int priceRate, @NonNull Popularity popularity,
