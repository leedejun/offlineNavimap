...
class AndroidNativeProvider extends BaseLocationProvider
{
  ...
  AndroidNativeProvider(@NonNull LocationFixChecker locationFixChecker)
  {
    ...
    mLocationManager = (LocationManager) FTMap.INSTANCE.getApp().getSystemService(Context.LOCATION_SERVICE);
  }
  ...
  {
    final LocationManager manager = (LocationManager) FTMap.INSTANCE.getApp().getSystemService(Context.LOCATION_SERVICE);
